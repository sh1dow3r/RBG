...
# iptables -A INPUT -p tcp -m multiport --dports 22,25,80,110,143,443 -j ACCEPT
# iptables -A INPUT -p tcp -s 192.168.1.10,192.168.1.69 -j ACCEPT
# iptables -A INPUT -p udp -s 192.168.1.10,192.168.1.69 -j ACCEPT
# iptables -A INPUT -p icmp --icmp-type 8 -j ACCEPT
# iptables -A INPUT -j DROP
# iptables -A OUTPUT -o lo -j ACCEPT
# iptables -A OUTPUT -m state --state ESTABLISHED -j ACCEPT
# iptables -A OUTPUT -p tcp -m multiport --sports 22,25,80,110,143,443 -j ACCEPT
# iptables -A OUTPUT -p tcp -d $DNSIP -j ACCEPT
# iptables -A OUTPUT -p udp -m multiport --dport 53,123 -d &lt;AD IP&gt; -j ACCEPT
# iptables -A OUTPUT -p udp --dport 514 -d 192.168.1.10 -j ACCEPT
...
# Back up smtp
cat /etc/postfix/main.cf > "/media/.backup/main.cf" 
